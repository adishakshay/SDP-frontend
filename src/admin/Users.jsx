...
const Users = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8082/signup/getall')
      .then(response => {
  ...
  const handleEditSubmit = (e) => {
    ...
    axios.put(`http://localhost:8082/adminuser/users/${editedEmail.toLowerCase()}`, updatedUser)
        .then(response => {
  ...
  const handleDelete = (email) => {
    axios.delete(`http://localhost:8082/adminuser/user/${email}`)
      .then(response => {
        if (response.data) {
  ...
  const handleAddUser = (e) => {
    ...
    axios.post('http://localhost:8082/signup/add', newUser)
      .then(response => {
